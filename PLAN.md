...
**End‑of‑week check:** Core observability deliverables are implemented and tested. Remaining artifact to capture: run the stack for 24+ hours and add a Grafana screenshot to the README.
